...
API_ID = int(environ.get('API_ID', '35630967')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '82c50539cd1f7570629e183eade7679c')  # API Hash from my.telegram.org
...
PICS_URL = (environ.get('PICS', 'https://files.catbox.moe/zxcj9i.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
PICS = (environ.get('PICS', 'https://files.catbox.moe/zxcj9i.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/e20b5fdaf217252964202.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://files.catbox.moe/zxcj9i.jpg")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5364814526 5685076977').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003829472848').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003838901135'))  # Log channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '1003157380405')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '1003531118666')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+u0mN4wsfEqNmYTM9')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1003611698738")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1003611698738")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://firestatus899:firestatus899@cluster0.tijf34p.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "firestatus899") # Database name (default: cluster)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+b6pZNRtWIjI5ZmY1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Ankit_Swami_Tihawali') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/Vaishanv') # Update channel link for the bot
